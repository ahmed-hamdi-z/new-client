  ...
  return (
    <>
      <div className="tabs flex justify-center space-x-4 mb-4 mt-36">
        <button
          className={`px-5 py-3 ml-3 rounded bg-gray-200 hover:bg-gray-300 transition-colors ${activeTab === 'all' ? 'bg-blue-500 text-white' : ''}`}
          onClick={() => setActiveTab('all')}
        >
          الكل
        </button>
        <button
          className={`px-5 py-2 rounded bg-gray-200 hover:bg-gray-300 transition-colors ${activeTab === 'residential' ? 'bg-blue-500 text-white' : ''}`}
          onClick={() => setActiveTab('residential')}
        >
          سكني
        </button>
        <button
          className={`px-5 py-2 rounded bg-gray-200 hover:bg-gray-300 transition-colors ${activeTab === 'commercial' ? 'bg-blue-500 text-white' : ''}`}
