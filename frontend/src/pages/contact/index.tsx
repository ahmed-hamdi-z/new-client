    ...
    <div className="  mx-auto xl:w-2/4 md:w-2/4 w-2/3 mt-52 ">
      ...
      <form className="w-full  " ref={form} onSubmit={sendEmail}>
        ...
        <input
          ...
          name="user_name"
        />
         <label className="mb-1 inline-block text-sm font-medium">Phone Numder</label>
        <input
          className="w-full rounded border-[1px] border-slate-300 px-2.5 py-1.5 focus:outline-indigo-600"
          type="number"
          name="user_number"
          placeholder="number"
        />
        <label className=" mb-1 inline-block text-sm font-medium">Email</label>
        <input
          className="w-full rounded border-[1px] border-slate-300 px-2.5 py-1.5 focus:outline-indigo-600"
          type="email"
          name="user_email"
        />
        <label className="mb-1 inline-block text-sm font-medium">Message</label>
        <textarea
        ...
        <label className="w-full  text-sm font-medium text-gray-900 dark:text-gray-300">Default radio</label>
